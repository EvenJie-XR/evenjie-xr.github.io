...
import { b as a, s as h } from './config.CbhC5vfi.js'
...
const d = `<svg viewBox="0 0 242.1 124" height="50">
  <g>
...
function p() {
  return c.jsx('div', { className: 'animated-signature', dangerouslySetInnerHTML: { __html: d } })
}
function x(t) {
  return new URL(t, h.url).href
}
function N({ title: t, slug: r, lastMod: n }) {
  const [l, o] = e.useState(''),
    s = x(r)
  function i() {
    navigator.clipboard.writeText(s), v.success('已复制文章链接')
  }
  return (
    e.useEffect(() => {
      o(m(n))
    ...
    c.jsxs('section', {
      className: 'text-xs leading-loose text-secondary',
      children: [
        c.jsxs('p', { children: ['文章标题：', t] }),
        c.jsxs('p', { children: ['文章作者：', a.name] }),
        c.jsxs('p', {
          children: [
            c.jsxs('span', { children: ['文章链接：', s] }),
            c.jsx('span', {
              role: 'button',
        ...
        c.jsxs('p', { children: ['最后修改时间：', l] }),
        c.jsx('hr', { className: 'my-3 border-primary' }),
        c.jsxs('div', {
          children: [
            c.jsx('div', { className: 'float-right ml-4 my-2', children: c.jsx(p, {}) }),
            c.jsxs('p', {
              children: [
