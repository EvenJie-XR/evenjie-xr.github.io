...
import { m as p } from './Swup.BPHaxb0p.js'
function a() {
  return (
    (a = Object.assign
      ? Object.assign.bind()
...
class g {
  constructor(o) {
    ;(this._raf = null),
      ...
      (this.scrollTo = (t) => {
        if (t && t.nodeType)
          this._targetPositionY = Math.round(t.getBoundingClientRect().top + window.pageYOffset)
        else {
      ...
      window.addEventListener(
        ...
        (t) => {
          this._raf &&
            (this.options.onCancel(), cancelAnimationFrame(this._raf), (this._raf = null))
        },
        { passive: !0 },
      )
  }
...
class S extends u {
  constructor(o = {}) {
    super(),
      ...
      (this.handleScrollToTop = (t) => {
        var s, i
        return (s = (i = this.swup).scrollTo) == null || s.call(i, 0, t.scroll.animate), !0
      }),
      ...
      (this.onVisitStart = (t) => {
        var s
        this.cacheScrollPositions(t.from.url), this.maybeResetScrollPositions(t)
      ...
      (this.doScrollingBetweenPages = (t) => {
        ...
        if ((e && this.maybeScrollToAnchor(e, t.scroll.animate)) || !t.scroll.reset) return
        const r = this.getCachedScrollPositions(t.to.url),
          l = (r == null || (i = r.window) == null ? void 0 : i.top) || 0
        requestAnimationFrame(() => {
          var h, d
          return (h = (d = this.swup).scrollTo) == null ? void 0 : h.call(d, l, t.scroll.animate)
        }),
      ...
      (this.maybeResetScrollPositions = (t) => {
        const { popstate: s } = t.history,
          { url: i } = t.to,
          { el: e } = t.trigger
        s || (e && !this.options.shouldResetScrollPosition(e)) || this.resetScrollPositions(i)
      }),
  ...
  mount() {
    ...
    ;(this.scrl = new g({
      ...
      o.options.animateHistoryBrowsing && (window.history.scrollRestoration = 'manual'),
  ...
  maybeScrollToAnchor(o, t = !1) {
    ...
    if (!(e instanceof Element)) return console.warn(`Anchor target ${o} is not a DOM node`), !1
  ...
  cacheScrollPositions(o) {
    const t = this.swup.resolveUrl(o),
      s = p(this.options.scrollContainers).map((e) => ({ top: e.scrollTop, left: e.scrollLeft })),
      i = { window: { top: window.scrollY, left: window.scrollX }, containers: s }
  ...
  restoreScrollContainers(o) {
    ...
    t &&
      ...
      p(this.options.scrollContainers).forEach((s, i) => {
  ...
  updateScrollTarget() {
    ...
    i instanceof HTMLBodyElement && (i = null),
      s !== i &&
        ...
        (o = i) == null || o.setAttribute('data-swup-scroll-target', ''))
  }
}
export { S as default }
