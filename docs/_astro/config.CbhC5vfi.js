const a = {
  ...
  o = {
    ...
    socials: [
      ...
      { name: 'X', icon: 'icon-x', url: 'https://twitter.com/lxchapu', color: 'rgb(36, 46, 54)' },
      {
        name: 'Email',
        icon: 'icon-mail',
  ...
  i = {
    ...
    border: { primary: { light: '#e4e4e7', dark: '#3f3f46' } },
  },
  c = [
    { name: '首页', link: '/', icon: 'icon-pantone' },
    { name: '归档', link: '/archives', icon: 'icon-archive' },
    { name: '项目', link: '/projects', icon: 'icon-flask' },
    { name: '关于', link: '/about', icon: 'icon-ghost' },
